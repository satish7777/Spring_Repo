...
public class LoggingAspect {
	...
	@Before("execution(* com.stackroute.keepnote.controller.*.createReminder(..))")
	public void beforeAdvice(JoinPoint joinPoint) {
		// System.out.println(joinPoint.getSignature());
		logger.info("Inside Before ", joinPoint.getSignature());
	}

	@After("execution(* com.stackroute.keepnote.controller.*.createReminder(..))")
	public void afterAdvice(JoinPoint joinPoint) {
		// System.out.println(joinPoint.getSignature());
		logger.info("Inside Before ", joinPoint.getSignature());
	}

	@AfterReturning(value = "execution(* com.stackroute.keepnote.controller.*.createReminder(..))", returning = "result")
	public void afterReturningAdvice(JoinPoint jp, Object result) {
		System.out.println("Inside the advice + controller" + result);
		logger.info("Inside the afterReturningAdvice");
	}

	@AfterThrowing(value = "execution(* com.stackroute.keepnote.controller.*.createReminder(..))", throwing = "result")
